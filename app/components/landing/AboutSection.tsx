...
export function AboutSection({ content }: AboutSectionProps) {
  return (
    <section id="about" className="border-y border-red-100 bg-red-50 scroll-mt-24">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div>
          ...
          <p className="mt-4 leading-8 text-red-900/80">
            {content.description}
          </p>
        </div>
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div
              className="h-28 rounded-xl border border-red-100 bg-cover bg-center shadow-sm sm:h-32"
              style={{
                backgroundImage:
          ...
          <div className="rounded-xl border border-red-100 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-5 text-red-900/80">
              {content.testimonials.map((testimonial) => (
                <figure key={testimonial.name}>
                  <blockquote className="italic">
                    &quot;{testimonial.quote}&quot;
                  </blockquote>
                  <figcaption className="mt-2 text-sm font-medium not-italic text-red-950">
